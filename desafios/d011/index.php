...
<body>
    ...
    <section>
        ...
        <p>O produto que custava <?=number_format($preco, 2, ",",".")?>, com <strong><?=$reaj?> de aumento</strong> vai passar a custar <strong><?=number_format($novo, 2, ",",".")?>R$</strong> a partir de agora. </p>
    </section>
    <script>
